...
import PowerEvolution from './components/PowerEvolution.vue'

// 维度配置
const dimensions = [
  { id: 'overview', name: '事件概览', icon: '📝' },
  { id: 'relations', name: '人物关系', icon: '🕸️' },
  { id: 'evolution', name: '权利演变', icon: '📈' }
]
...
const currentComponent = computed(() => {
  ...
  if (currentDimId.value === 'relations') return Relations
  if (currentDimId.value === 'evolution') return PowerEvolution
  return null
})
</script>
